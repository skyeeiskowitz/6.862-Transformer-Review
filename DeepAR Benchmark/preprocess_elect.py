...
if __name__ == '__main__':
    ...
    # train_end = '2011-08-31 23:00:00'
    # test_start = '2011-08-25 00:00:00' #need additional 7 days as given info
    # test_end = '2011-09-07 23:00:00'
    #Original trains on data from 1/1/2011-8/31/2014
    ...
    if not os.path.exists(csv_path): #Pasted LD2011_2014.txt in ./data/elct to avoid this from running
